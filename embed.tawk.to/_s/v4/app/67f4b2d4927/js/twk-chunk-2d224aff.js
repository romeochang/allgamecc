(window.tawkJsonp = window.tawkJsonp || []).push([
  ["chunk-2d224aff"],
  {
    e0ca: function (t, e, i) {
      ...
      var l = {
          name: "min-content",
          components: { TawkImage: n.TawkImage },
                            ...
                            ? e(
                                "svg",
                                {
                                  ...
                                  attrs: {
                                    ...
                                    "aria-labelledby":
                                      "closeIconTitle closeIconDesc",
                                  },
                                },
                                [
                                  e(
                                    "title",
                                    { attrs: { id: "closeIconTitle" } },
                                    [t._v("Close Chat")]
                                  ),
                                  e(
                                    "desc",
                                    { attrs: { id: "closeIconDesc" } },
                                    [t._v("This icon closes the chat window.")]
                                  ),
                                  e("path", {
                                    attrs: {
                                      "fill-rule": "evenodd",
                          ...
                          : e(
                              "svg",
                              {
                                ...
                                attrs: {
                                  ...
                                  "aria-labelledby":
                                    "openIconTitle openIconDesc",
                                },
                              },
                              [
                                e("title", { attrs: { id: "openIconTitle" } }, [
                                  t._v("Opens Chat"),
                                ]),
                                e("desc", { attrs: { id: "openIconDesc" } }, [
                                  t._v("This icon Opens the chat window."),
                                ]),
                                e("path", {
                                  attrs: {
                                    "fill-rule": "evenodd",
      ...
      var b = {
          ...
          computed: g(
            ...
            {},
            {
              ...
              styleObject: function () {
                var t,
                  e,
                  i = this.mobileBrowserName ? this.minMobile : this.minDesktop,
                  o = {
                ...
                this.mobileBrowserName
                  ? this.isMobileLandscape
                    ? "safari" === this.mobileBrowserName
                      ? ((t = this.xOffsetMobile), (e = this.yOffsetMobile))
                      : ((t = this.xOffsetMobile / 1.7),
                        (e = this.yOffsetMobile / 1.7))
                    : ((t = this.xOffsetMobile), (e = this.yOffsetMobile))
                  : ((t = this.xOffset), (e = this.yOffset));
                var n = t * this.zoomRatio;
                if (
                  (this.isRight
                    ? (o["right:"] = "".concat(n, "px !important;"))
                    : (o["left:"] = "".concat(n, "px !important;")),
                  this.isCenter)
                ) {
                  if (
                    ((o["top:"] = "calc((50% - "
                      .concat(0.5 * i.height, "px) + ")
                      .concat(e, "px) !important;")),
                    !this.isRoundWidget)
                  ) {
                    var s = 0.5 * i.height - 0.5 * i.width + t,
                      a = "49% !important",
                      r = "rotate(".concat(
              ...
              badgePosition: function () {
                ...
                return (
                  this.mobileBrowserName &&
                    this.resizeWidth &&
                    (i.width = this.resizeWidth + 5),
                  this.isRoundWidget
                    ? ((t = "".concat(i.width - 20, "px")),
                      (e = "".concat(i.height - 20, "px")))
                    : ((t = "".concat(i.width - 16, "px")),
              ...
              hideMinimizeWidget: function () {
                return (
                  "slide" === this.onClick && "max" === this.chatWindowState
                );
              },
            }
          ),
          ...
          methods: g(
            g({}, Object(o.b)({ toggleWidget: "session/toggleWidget" })),
            {},
            {
              loaded: function () {
                var t = this;
                  ...
                  this.mobileBrowserName &&
                    ...
                    ("iphone" !== this.os.identity &&
                      ...
                      ? "safari" === this.mobileBrowserName ||
                        ("iphone" !== this.os.identity &&
                          "mac" !== this.os.identity) ||
                        (i = "scale(".concat(this.zoomRatio / 1.7, ")"))
                      : (i = "scale(".concat(1.2 * this.zoomRatio, ")")));
                var o = "-moz-transform: "
                    .concat(i, ";\n\t\t\t\t\t\t\t-webkit-transform: ")
                    .concat(i, ";\n\t\t\t\t\t\t\t-o-transform: ")
                    .concat(i, ";\n\t\t\t\t\t\t\t-ms-transform: ")
                  ...
                  setTimeout(function () {
                    if (
                      ...
                      t.resizeWidth > screen.width &&
                        ...
                        (i.className += " tawk-text-truncate"));
                    }
                  }, 1e3 / 66);
              },
            }
                ...
                e(
                  ...
                  [
                    ...
                    e(
                      ...
                      {
                        staticClass:
                          "tawk-custom-color tawk-custom-border-color tawk-outline",
